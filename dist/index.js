            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.channelManager.channelById(channelId)];
                    case 1:
                        channel = _a.sent();
                        if (!channel) {
                            throw new Error('No payment channel found.');
                        }
                        return [2 /*return*/, this.channelContract.deposit(this.account, channelId, _value)];
                }
            });
        });
    };
    Machinomy.prototype.open = function (receiver, value) {
        return __awaiter(this, void 0, void 0, function () {
            var _value;
            return __generator(this, function (_a) {
                _value = new BigNumber.BigNumber(value);
                return [2 /*return*/, this.channelManager.openChannel(this.account, receiver, new BigNumber.BigNumber(0), _value)];
            });
        });
    };
    /**
