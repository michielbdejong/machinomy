...
var ChannelContract = /** @class */ (function () {
    ...
    ChannelContract.prototype.claim = function (receiver, channelId, value, signature) {
        return __awaiter(this, void 0, void 0, function () {
            var deployed;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        deployed = _a.sent();
                        return [2 /*return*/, deployed.claim(channelId, value, signature.toString(), { from: receiver })];
                }
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        isOpen = _a.sent();
                        return [4 /*yield*/, deployed.isSettling(channelId)];
                    case 3:
                        isSettling = _a.sent();
                        if (isOpen) {
                            return [2 /*return*/, 0];
    ...
    ChannelContract.prototype.getSettlementPeriod = function (channelId) {
        return __awaiter(this, void 0, void 0, function () {
            var deployed, exists, chan;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        deployed = _a.sent();
                        return [4 /*yield*/, deployed.isPresent(channelId)];
                    case 2:
                        exists = _a.sent();
                        if (!exists) {
                            throw new Error("Cannot fetch settlement period for non-existent channel " + channelId + ".");
                        }
                        return [4 /*yield*/, deployed.channels(channelId)];
                    case 3:
                        chan = _a.sent();
                        return [2 /*return*/, chan[3]];
                }
            });
        });
    };
