 ...
 */
var provider = new Web3.providers.HttpProvider(process.env.MACHINOMY_GETH_ADDR);
var web3 = new Web3(provider);
/**
 * Create machinomy instance that provides API for accepting payments.
 */
var machinomy = new index_1["default"](receiver, web3, { databaseUrl: 'mongodb://localhost:27017/machinomy' });
var hub = express();
...
app.get('/content', function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
    var reqUrl, content, token, response, json, status;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
